...
王晓玲教授是教育部新世纪人才计划获得者，教育部装备预研创新团队负责人，她的研究兴趣包括**大数据智能分析技术**、**可信人工智能**。目前是《Chinese Journal of Information Fusion》国际期刊领域主编（Specialty Chief Editors），上海计算机学会数据库专委会**主任委员**，中国航空学会信息融合分会知识融合专业组**主任**。她在SIGMOD、SIGIR、AAAI、IJCAI、ICDE、WWW、ICWS、CIKM、DASFAA、APWEB等国际重要学术会议上发表篇论文**150**余篇，在IEEE TKDE、JWSR、WWWJ、JCST、《计算机学报》、《软件学报》等国内外学术期刊上发表论文**70**余篇。她共主持科技部、工信部、国家自然科学基金委等国家级和省部级项目**20**余项（其中，主持国家自然科学基金项目**6**项），**4**次荣获省部级科技进步奖，**13**次获得会议优秀论文称号，获得发明专利**19**项，获得软件著作权**31**项，出版英文专著**2**本，中文专著**6**本。
